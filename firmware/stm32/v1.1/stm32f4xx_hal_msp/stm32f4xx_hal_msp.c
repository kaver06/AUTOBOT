...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM2)
  {
    ...
    PB8     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = FR_TRIG_Pin|GPIO_PIN_8;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM2)
  {
    ...
    PB8     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(GPIOB, FR_ECHO_Pin|FR_TRIG_Pin|F_ECHO_Pin|GPIO_PIN_8);
  ...
  else if(htim_base->Instance==TIM3)
  {
    ...
    PC7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOC, FL_TRIG_Pin|F_L_ECHO_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM4)
  {
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, RE_CH_A_Pin|RE_CH_B_Pin);
  ...
  else if(htim_encoder->Instance==TIM5)
  {
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, LE_CH_A_Pin|LE_CH_B_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, ESP_CAM_RX_Pin|ESP_CAM_TX_Pin);
  ...
  else if(huart->Instance==USART2)
  {
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, HC05_RX_Pin|HC05_TX_Pin);
