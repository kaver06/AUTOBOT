...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
extern osThreadId_t ESP_RXHandle;
	  ...
	  if (__HAL_UART_GET_FLAG(&huart1, UART_FLAG_IDLE))
	    {
	        ...
	        uint16_t len =
	            RX_BUFFER_SIZE - __HAL_DMA_GET_COUNTER(huart1.hdmarx);

	        memcpy(uart1_data, uart1_rx_buffer, len);
	        uart1_data[len] = '\0';
	        ...
	        osThreadFlagsSet(ESP_RXHandle, 0x01);
...
//		extern char usart2_cmd_buffer[10];
//		extern uint8_t usart2_cmd_index;
//		extern osEventFlagsId_t obstacleFlags;
//
//		if (__HAL_UART_GET_FLAG(&huart2, UART_FLAG_RXNE))
//		{
//		    uint8_t ch = huart2.Instance->DR;
//
//		    if (ch == '\n' || ch == '\r')
//		    {
